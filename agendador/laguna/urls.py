...
from .views import register_view, delete_reservation_view, agenda_view, login_view, logout_view, home_view, select_date_view, select_time_slot_view, select_court_view, admin_schedule_view
