...
from .views import register_view, select_bbq_view, delete_bbq_reservation, select_date_bbq_view, select_time_slot_bbq_view, delete_reservation_view, agenda_view, login_view, logout_view, home_view, select_date_view, select_time_slot_view, select_court_view, admin_schedule_view
